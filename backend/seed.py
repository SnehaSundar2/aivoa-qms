...
COMPLAINTS = [
    dict(
        ...
        impacted_npm='Primary packaging - blister foil',
        suggested_next_action='Log for trending & acknowledge to customer',
        initial_risk_assessment='Probable mechanical damage at the packaging deduster or low tablet hardness. Cosmetic only, with no impact on dose delivery.',
        complainant_name="Dr. Anita Rao",
        customer_name="Meridian Hospital Pharmacy",
    ...
    dict(
        ...
        impacted_npm='Primary packaging - HDPE drum and liner',
        suggested_next_action='Route to QC re-test & assess Field Alert Report',
        initial_risk_assessment='Possible moisture ingress through the drum liner during transit or storage. Requires retention sample re-test and shipping record review.',
        complainant_name="Marcus Feld",
        customer_name="NordPharm Distribution GmbH",
    ...
    dict(
        ...
        originating_site_block='Block D - Liquids & Semi-solids',
        impacted_npm='Primary packaging - induction seal and bottle closure',
        suggested_next_action='Route to QA Investigation & issue replacement',
        initial_risk_assessment='Induction sealer temperature or dwell time likely outside the validated range. Container closure integrity cannot be assured.',
        complainant_name="Priya Nair",
        customer_name="CarePlus Retail Pharmacy Chain",
        ...
        expiry_date="October 2027",
        affected_quantity="3 bottles",
    ...
    dict(
        ...
        complaint_source='Hospital',
        originating_site_block='Block B - Sterile Injectables',
        impacted_npm='Primary packaging - glass vial and stopper',
        suggested_next_action='Escalate to QA Head & initiate health hazard evaluation',
        initial_risk_assessment='Visible particulate in a parenteral product, possibly stopper or filtration related. Immediate batch quarantine and FAR assessment.',
        complainant_name="Thomas Bergstrom",
        customer_name="Lakeside Regional Medical Center",
    ...
    dict(
        ...
        complaint_source='Distributor',
        originating_site_block='Block B - Sterile Injectables',
        impacted_npm='Secondary packaging - insulated shipper and gel packs',
        suggested_next_action='Route to QA for stability impact assessment',
        initial_risk_assessment='Cold chain excursion beyond the qualified shipper duration. Product disposition depends on the stability impact assessment.',
        complainant_name="Sofia Almeida",
        customer_name="Iberia Pharma Logistics SA",
        ...
        affected_quantity="1 pallet (300 pens)",
    ...
    dict(
        ...
        complaint_source='Pharmacy',
        originating_site_block='Block E - Packaging & Labelling',
        impacted_npm='Secondary packaging - printed carton',
        suggested_next_action='Route to QA Investigation & issue replacement',
        initial_risk_assessment='Overprinting unit likely out of adjustment or low on ink. Batch traceability at the point of dispensing is compromised.',
        complainant_name="Kevin Osei",
        customer_name="Accra Central Pharmacy",
        ...
        expiry_date="January 2028",
        affected_quantity="1 carton",
